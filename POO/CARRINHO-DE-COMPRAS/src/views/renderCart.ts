...
export function renderCart(items: CartItem[], totalQuantity: number, totalPrice: number): string {
...
function renderFilledCart(items: CartItem[], totalQuantity: number, totalPrice: number): string {
...
function renderOrderModal(itemsHtml: string, totalPrice: number): string {
  return `
